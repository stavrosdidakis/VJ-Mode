{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 662.0, 44.0, 874.0, 433.0 ],
		"bglocked" : 0,
		"defrect" : [ 662.0, 44.0, 874.0, 433.0 ],
...
, 											{
												"box" : 												{
													"maxclass" : "newobj",
													"text" : "pack script new ffparam1visXXXXX bpatcher 2 0 246 19 0 0 freeframe_param1vis.maxpat 0 s s",
													"numoutlets" : 1,
													"id" : "obj-24",
													"fontname" : "Arial",
													"outlettype" : [ "" ],
...
, 											{
												"box" : 												{
													"maxclass" : "newobj",
													"text" : "sprintf script delete ffparam1vis%ld",
													"numoutlets" : 1,
													"id" : "obj-25",
													"fontname" : "Arial",
													"outlettype" : [ "" ],
...
, 			{
				"box" : 				{
					...
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 928.0, 384.0, 727.0, 558.0 ],
						"bglocked" : 0,
						"defrect" : [ 928.0, 384.0, 727.0, 558.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
