{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 663.0, 408.0, 553.0, 412.0 ],
		"bglocked" : 0,
		"defrect" : [ 663.0, 408.0, 553.0, 412.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "" ],
					"patching_rect" : [ 38.0, 123.0, 53.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 176.0, 342.0, 205.0, 266.0 ],
						"bglocked" : 0,
						"defrect" : [ 176.0, 342.0, 205.0, 266.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
...
, 							{
								"box" : 								{
									...
									"patcher" : 									{
										"fileversion" : 1,
										"rect" : [ 27.0, 652.0, 640.0, 480.0 ],
										"bglocked" : 0,
										"defrect" : [ 27.0, 652.0, 640.0, 480.0 ],
										"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
										"openinpresentation" : 0,
										"default_fontsize" : 12.0,
										"default_fontface" : 0,
...
, 											{
												"box" : 												{
													...
													"id" : "obj-15",
													"fontname" : "Arial",
													"patching_rect" : [ 122.0, 122.0, 67.0, 20.0 ],
													"fontsize" : 12.0,
													"numinlets" : 1
												}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"varname" : "storgFxStd2vis",
					"text" : "autopattr storgFxStd2vis",
					"numoutlets" : 4,
					"id" : "obj-69",
					"fontname" : "Arial",
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 231.0, 166.0, 108.0, 17.0 ],
					"fontsize" : 9.0,
					"numinlets" : 1,
					"restore" : 					{
						"umenufxStd2vis" : [ 0 ]
...
, 			{
				"box" : 				{
					...
					"id" : "obj-10",
					"fontname" : "Arial",
					"patching_rect" : [ 234.0, 4.0, 52.0, 20.0 ],
					"fontface" : 1,
					"textcolor" : [ 0.698039, 0.698039, 0.698039, 1.0 ],
					"fontsize" : 12.0,
...
, 			{
				"box" : 				{
					...
					"items" : [ "Blur", ",", "Rectanguler", ",", "Scroller", ",", "Slices", ",", "Fade", "Noise", ",", "Cross", "Spectrum", ",", "Kaleidoscope", ",", "LEDs", ",", "Fuzzy", ",", "Hue" ],
					"arrowlink" : 0,
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 8.0, 212.0, 69.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 1,
					"save" : [ "#N", "thispatcher", ";", "#Q", "end", ";" ]
				}
...
, 			{
				"box" : 				{
					...
					"fontname" : "Arial",
					"outlettype" : [ "int" ],
					"patching_rect" : [ 23.0, 151.0, 68.0, 20.0 ],
					"fontsize" : 12.0,
					"numinlets" : 2
				}
...
, 			{
				"box" : 				{
					...
					"color" : [ 0.929412, 0.360784, 0.866667, 1.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 132.0, 113.0, 40.0, 17.0 ],
					"fontsize" : 9.0,
					"hidden" : 1,
					"numinlets" : 2,
					"patcher" : 					{
						"fileversion" : 1,
						"rect" : [ 341.0, 417.0, 1099.0, 509.0 ],
						"bglocked" : 0,
						"defrect" : [ 341.0, 417.0, 1099.0, 509.0 ],
						"openrect" : [ 0.0, 0.0, 0.0, 0.0 ],
						"openinpresentation" : 0,
						"default_fontsize" : 12.0,
						"default_fontface" : 0,
