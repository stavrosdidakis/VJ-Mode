{
	"patcher" : 	{
		"fileversion" : 1,
		"rect" : [ 679.0, 44.0, 677.0, 551.0 ],
		"bglocked" : 0,
		"defrect" : [ 679.0, 44.0, 677.0, 551.0 ],
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"fontsize" : 11.595187,
					"numoutlets" : 1,
					"patching_rect" : [ 349.0, 35.0, 32.5, 20.0 ],
					"outlettype" : [ "int" ],
					"id" : "obj-1",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.595187,
					"numoutlets" : 1,
					"patching_rect" : [ 349.0, 9.0, 80.0, 20.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-15",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 11.595187,
					"numoutlets" : 0,
					"patching_rect" : [ 6.0, 145.0, 74.0, 20.0 ],
					"id" : "obj-14",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 1,
					"patching_rect" : [ 6.0, 119.0, 53.0, 20.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-20",
					"fontname" : "Arial",
					"patcher" : 					{
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"fontsize" : 12.0,
									"numoutlets" : 1,
									"patching_rect" : [ 115.0, 66.0, 46.200001, 20.0 ],
									"outlettype" : [ "int" ],
									"id" : "obj-1",
									"fontname" : "Arial"
								}
...
, 							{
								"box" : 								{
									...
									"fontsize" : 12.0,
									"numoutlets" : 1,
									"patching_rect" : [ 115.0, 100.0, 49.0, 20.0 ],
									"outlettype" : [ "" ],
									"id" : "obj-2",
									"fontname" : "Arial",
									"patcher" : 									{
...
, 							{
								"box" : 								{
									...
									"fontsize" : 11.595187,
									"numoutlets" : 2,
									"patching_rect" : [ 115.0, 126.0, 67.0, 20.0 ],
									"outlettype" : [ "", "" ],
									"id" : "obj-3",
									"fontname" : "Arial",
...
, 											{
												"box" : 												{
													...
													"fontsize" : 12.0,
													"numoutlets" : 0,
													"patching_rect" : [ 118.0, 100.0, 52.0, 20.0 ],
													"id" : "obj-15",
													"fontname" : "Arial"
												}
...
, 			{
				"box" : 				{
					"maxclass" : "newobj",
					"varname" : "storgFxStd2",
					"text" : "autopattr storgFxStd2",
					"numinlets" : 1,
					"fontsize" : 9.0,
					"numoutlets" : 4,
					"patching_rect" : [ 234.0, 136.0, 97.0, 17.0 ],
					"outlettype" : [ "", "", "", "" ],
					"id" : "obj-69",
					"fontname" : "Arial",
					"restore" : 					{
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 1,
					"patching_rect" : [ 163.0, 152.0, 60.0, 20.0 ],
					"outlettype" : [ "bang" ],
					"id" : "obj-13",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 1,
					"patching_rect" : [ 163.0, 201.0, 32.5, 18.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-8",
					"fontname" : "Arial"
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 2,
					"patching_rect" : [ 163.0, 177.0, 32.5, 20.0 ],
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 2,
					"patching_rect" : [ 13.0, 227.0, 69.0, 20.0 ],
					"outlettype" : [ "", "" ],
					"id" : "obj-12",
					"fontname" : "Arial",
					"save" : [ "#N", "thispatcher", ";", "#Q", "end", ";" ]
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 1,
					"patching_rect" : [ 13.0, 192.0, 25.0, 25.0 ],
					"outlettype" : [ "" ],
					"id" : "obj-11",
					"comment" : ""
				}
...
, 			{
				"box" : 				{
					...
					"fontsize" : 9.0,
					"numoutlets" : 1,
					"patching_rect" : [ 116.0, 24.0, 40.0, 17.0 ],
					"outlettype" : [ "" ],
					"hidden" : 1,
					"id" : "obj-4",
					"fontname" : "Arial",
...
, 			{
				"box" : 				{
					...
					"fontsize" : 12.0,
					"numoutlets" : 0,
					"patching_rect" : [ 210.0, 4.0, 107.0, 20.0 ],
					"textcolor" : [ 0.698039, 0.698039, 0.698039, 1.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 2.0, 0.0 ],
					"patching_rect" : [ 3.0, 24.0, 156.0, 79.0 ],
					"name" : "fx2.maxpat",
					"id" : "obj-2"
				}
